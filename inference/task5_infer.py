...
if __name__=='__main__':
    ...
    lora_path = '/bohr/sci-lora-model-q9h7/v14/yi-lora-task5-0902'
    ...
    task5_answer = []
    for i, obj in enumerate(task5_questions):
        obj['ideal'] = ans[i]
        task5_answer.append(obj)
    with jsonlines.open('task5_answer.jsonl', 'w') as file:
        file.write_all(task5_answer)