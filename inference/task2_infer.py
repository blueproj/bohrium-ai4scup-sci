...
if __name__=='__main__':
    ...
    lora_path = '/bohr/sci-lora-model-q9h7/v14/yi-lora-task2-0911'
    ...
    task2_answer = []
    for i, obj in enumerate(task2_questions):
        obj['ideal'] = ans[i]
        task2_answer.append(obj)
    with jsonlines.open('task2_answer.jsonl', 'w') as file:
        file.write_all(task2_answer)